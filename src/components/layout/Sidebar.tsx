...
export const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
      <div className="flex h-full flex-col justify-between">
        <div>
          ...
          <div className="overflow-y-auto px-3 py-4 space-y-6 max-h-[calc(100vh-220px)]">
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    {isCollapsed && item.id === 'tasks' && item.urgency && (
              ...
              <div>
                <div className="mb-2 flex items-center justify-between px-3">
                  ...
                  <button
                    ...
                    className="flex h-5 w-5 items-center justify-center rounded-md text-slate-400 hover:bg-slate-100 hover:text-slate-600 dark:hover:bg-slate-800"
                  >
        ...
        <div className="border-t border-slate-100 p-3 dark:border-slate-800/80 space-y-2">
          ...
          >
            ...
            {!isCollapsed && <span>Settings & Shortcuts</span>}
          </button>
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'hidden md:flex relative flex-col border-r border-slate-200/80 bg-white transition-all duration-300 select-none dark:border-slate-800 dark:bg-[#0F172A]',
          collapsed ? 'w-20' : 'w-64'
        )}
      >
      ...
      {/* Mobile Drawer (visible only when isMobileOpen is true on mobile screens) */}
      {isMobileOpen && (
        <div className="fixed inset-0 z-50 flex md:hidden">
          <div
            ...
            onClick={onCloseMobile}
          />
          <aside className="relative z-50 flex h-full w-72 max-w-[85vw] flex-col bg-white shadow-2xl dark:bg-[#0F172A] animate-in slide-in-from-left duration-200 select-none">
